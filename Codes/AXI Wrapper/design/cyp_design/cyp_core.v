module crop_yield(
    ...
    output reg [63:0] yield_int,
    output reg        ready
);

    reg [63:0] yield_f_reg;

    // -------------------------------------------------
    // IEEE-754 comparison function (synthesizable)
    // -------------------------------------------------
    ...
    // -------------------------------------------------
    // Decision Tree wire (combinational)
    // -------------------------------------------------
    always @(*) begin
        yield_f_reg = 64'd0;
