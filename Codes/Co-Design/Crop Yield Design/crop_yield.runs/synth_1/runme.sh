...
HD_PWD='D:/PC/Shared Folder/Uni/courses/ERI/github/ERI_SVM_FPGA_PROJECT/Codes/Co-Design/Crop Yield Design/crop_yield.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log random_forest_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source random_forest_seq.tcl
