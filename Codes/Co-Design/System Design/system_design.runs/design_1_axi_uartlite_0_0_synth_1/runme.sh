...
HD_PWD='D:/All/Ali/Shared Folder/Uni/courses/ERI/github/ERI_SVM_FPGA_PROJECT/Codes/Co-Design/System Design/system_design.runs/design_1_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
