if (LE(Fertilizer_Used, 64'h406B04A3E0000000)) begin
    if (LE(Rainfall, 64'h4096AA3D70000000)) begin
        if (LE(Soil_Moisture, 64'h403523D700000000)) begin
            if (LE(Fertilizer_Used, 64'h4061A4CCD0000000)) begin
            ...
            if (LE(Fertilizer_Used, 64'h405B37AE10000000)) begin
                if (LE(Wind_Speed, 64'h400EA3D700000000)) begin
                    yield_f_reg = 64'h40198A3D70A3D70A;
                end else begin
                    if (LE(K, 64'h4055E00000000000)) begin
                        if (LE(Rainfall, 64'h408FDCF5C0000000)) begin
                            yield_f_reg = 64'h4011851EB851EB85;
                        end else begin
                            yield_f_reg = 64'h4015666666666666;
                        end
                    end else begin
                        if (LE(Rainfall, 64'h408A520000000000)) begin
                ...
                if (LE(Wind_Speed, 64'h4023EB8520000000)) begin
                    ...
                    if (LE(Soil_pH, 64'h401D7AE140000000)) begin
                        if (LE(K, 64'h4052000000000000)) begin
        ...
        if (LE(Fertilizer_Used, 64'h406347AE10000000)) begin
            if (LE(Soil_Moisture, 64'h404983D710000000)) begin
                if (LE(Rainfall, 64'h409DB96B80000000)) begin
                    if (LE(Wind_Speed, 64'h401FD1EB90000000)) begin
                        yield_f_reg = 64'h401AEB851EB851EC;
                    end else begin
                        if (LE(Soil_Moisture, 64'h4040B51EB0000000)) begin
                    ...
                    if (LE(Humidity, 64'h4051C199A0000000)) begin
                        if (LE(P, 64'h4044C00000000000)) begin
                            yield_f_reg = 64'h40183851EB851EB8;
                        end else begin
                            yield_f_reg = 64'h401BC28F5C28F5C3;
                        end
                    end else begin
                        if (LE(Wind_Speed, 64'h40251C28F0000000)) begin
                ...
                if (LE(N, 64'h4058400000000000)) begin
            ...
            if (LE(Wind_Speed, 64'h4022A8F5D0000000)) begin
                if (LE(Soil_Moisture, 64'h404483D700000000)) begin
                    if (LE(Humidity, 64'h404BFF5C30000000)) begin
                        yield_f_reg = 64'h401D5C28F5C28F5C;
                    end else begin
                        yield_f_reg = 64'h4021EE147AE147AE;
                    end
                end else begin
                    if (LE(Humidity, 64'h404A4A3D70000000)) begin
                ...
                if (LE(Rainfall, 64'h409AC60000000000)) begin
    ...
    if (LE(Rainfall, 64'h409B440520000000)) begin
        if (LE(Soil_Moisture, 64'h403CF47AE0000000)) begin
            if (LE(N, 64'h405CE00000000000)) begin
                if (LE(Humidity, 64'h404923D710000000)) begin
                    yield_f_reg = 64'h401C47AE147AE148;
                end else begin
                    if (LE(Altitude, 64'h40915C0000000000)) begin
            ...
            if (LE(Wind_Speed, 64'h40224A3D70000000)) begin
                if (LE(Rainfall, 64'h408F72E150000000)) begin
                    if (LE(Humidity, 64'h404E90A3D0000000)) begin
                        if (LE(Organic_Carbon, 64'h3FEE3D70A0000000)) begin
                ...
                if (LE(Fertilizer_Used, 64'h4070E799A0000000)) begin
                    if (LE(Soil_pH, 64'h401C9999A0000000)) begin
                        if (LE(Soil_Moisture, 64'h40480A3D70000000)) begin
                            yield_f_reg = 64'h401D5C28F5C28F5C;
                        end else begin
                    ...
                    if (LE(Soil_pH, 64'h40168A3D70000000)) begin
                        ...
                        if (LE(Rainfall, 64'h4089FB70A0000000)) begin
        ...
        if (LE(N, 64'h4052600000000000)) begin
            if (LE(Wind_Speed, 64'h4020851EB0000000)) begin
                yield_f_reg = 64'h40220F5C28F5C28F;
            end else begin
                if (LE(Soil_Moisture, 64'h404805C290000000)) begin
            ...
            if (LE(K, 64'h404C000000000000)) begin
                if (LE(Temperature, 64'h4036D70A40000000)) begin
                    yield_f_reg = 64'h402099999999999A;
                end else begin
                    yield_f_reg = 64'h40226147AE147AE1;
                end
            end else begin
                if (LE(P, 64'h404C400000000000)) begin
                    if (LE(Soil_pH, 64'h401B333330000000)) begin
                        yield_f_reg = 64'h4022FAE147AE147B;
                    end else begin
                        yield_f_reg = 64'h4021333333333333;
                    end
                end else begin
                    if (LE(Soil_Moisture, 64'h40469B8520000000)) begin
                        if (LE(Rainfall, 64'h40A0751480000000)) begin
                        ...
                        if (LE(Soil_Type, 64'h3FF8000000000000)) begin
                            yield_f_reg = 64'h4025400000000000;
                        end else begin
