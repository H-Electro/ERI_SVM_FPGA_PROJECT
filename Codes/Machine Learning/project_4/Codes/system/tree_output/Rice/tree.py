        ...
        if features['Rainfall'] <= 1731.0900268555:
            if features['Fertilizer_Used'] <= 140.2049942017:
                if features['Rainfall'] <= 897.4299926758:
                    if features['Soil_Moisture'] <= 47.9549999237:
                        if features['K'] <= 94.5000000000:
                            if features['Pesticide_Used'] <= 9.1050000191:
                                return 7.0731250000
                            else:
                                return 6.2228000000
                        else:
                    ...
                    if features['Wind_Speed'] <= 6.2300000191:
                        if features['K'] <= 98.5000000000:
                            return 7.9768965517
                        else:
                            return 9.1295454545
                    else:
                        if features['Soil_Moisture'] <= 38.4849987030:
                            if features['Fertilizer_Used'] <= 81.6900024414:
                                return 6.8233333333
                            else:
                                return 7.5135000000
                        else:
                ...
                if features['Soil_Moisture'] <= 44.0450000763:
                    if features['Soil_pH'] <= 7.6000001431:
                        if features['N'] <= 85.0000000000:
                            if features['Pesticide_Used'] <= 12.6299996376:
                                return 8.3706666667
                            else:
                                return 7.5506666667
                        else:
                            if features['Rainfall'] <= 1086.0199584961:
                                if features['Soil_pH'] <= 6.2249999046:
                                    return 8.1187500000
                                else:
                                    return 8.8173333333
                            else:
                    ...
                    if features['Sunlight_Hours'] <= 10.0050001144:
                        if features['N'] <= 88.5000000000:
                            return 8.2795238095
                        else:
                            if features['Organic_Carbon'] <= 0.8600000143:
                                return 8.6666666667
                            else:
                                return 9.9040000000
                    else:
            ...
            if features['Fertilizer_Used'] <= 134.1699981689:
                if features['Soil_Moisture'] <= 40.8199996948:
                    if features['Soil_pH'] <= 7.2149999142:
                        if features['Wind_Speed'] <= 8.0799999237:
                            return 9.4548000000
                        else:
                            return 8.5822727273
                    else:
                ...
                if features['Sunlight_Hours'] <= 8.4699997902:
                    if features['Humidity'] <= 48.1700000763:
                        ...
                        if features['Altitude'] <= 734.0000000000:
                            ...
                            if features['Rainfall'] <= 2152.3850097656:
                                return 9.7383333333
                            else:
                                return 10.1804545455
                else:
                    if features['Humidity'] <= 64.9399986267:
                        return 8.7050000000
                    else:
                        return 9.9938095238
    else:
        if features['Rainfall'] <= 1553.9000244141:
            if features['Soil_Moisture'] <= 42.4000015259:
                if features['Fertilizer_Used'] <= 298.8450012207:
                    if features['Soil_Moisture'] <= 30.4099998474:
                        if features['Rainfall'] <= 704.2500000000:
                            ...
                            if features['Soil_pH'] <= 6.9400000572:
                                if features['Soil_pH'] <= 5.7249999046:
                                    return 8.5056250000
                                else:
                                    return 9.3317391304
                            else:
                    ...
                    if features['Soil_pH'] <= 7.1150000095:
                        if features['Temperature'] <= 24.7599992752:
                ...
                if features['K'] <= 76.5000000000:
                    if features['Soil_pH'] <= 5.7850000858:
                        return 8.5168421053
                    else:
                    ...
                    if features['Fertilizer_Used'] <= 249.7550048828:
                        if features['Rainfall'] <= 925.5299987793:
                            return 9.2312500000
                        else:
                            return 9.8760000000
                    else:
                        if features['Organic_Carbon'] <= 1.0199999809:
                            ...
                            if features['Soil_pH'] <= 6.7049999237:
            ...
            if features['Fertilizer_Used'] <= 284.4949951172:
                if features['Soil_Moisture'] <= 44.1399993896:
                    if features['Wind_Speed'] <= 5.6150000095:
                        if features['Wind_Speed'] <= 2.9400000572:
                    ...
                    if features['Rainfall'] <= 2543.8599853516:
                        if features['P'] <= 32.5000000000:
                            ...
                            if features['Region'] <= 3.5000000000:
                                if features['Organic_Carbon'] <= 0.5850000083:
                                    return 10.6194736842
                                else:
                                    if features['Soil_Moisture'] <= 36.7349987030:
