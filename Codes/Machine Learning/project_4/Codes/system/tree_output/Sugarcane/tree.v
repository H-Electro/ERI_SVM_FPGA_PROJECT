if (LE(Fertilizer_Used, 64'h406D3C7AE0000000)) begin
    if (LE(Rainfall, 64'h408F010A40000000)) begin
        if (LE(K, 64'h405FA00000000000)) begin
            if (LE(Wind_Speed, 64'h402B0F5C30000000)) begin
                if (LE(Soil_Moisture, 64'h40482D70A0000000)) begin
                    if (LE(Soil_pH, 64'h401D0A3D70000000)) begin
                    ...
                    if (LE(Fertilizer_Used, 64'h40633570A0000000)) begin
        ...
        if (LE(Rainfall, 64'h40A16CAB80000000)) begin
            if (LE(Soil_Moisture, 64'h4049B1EB80000000)) begin
                if (LE(Fertilizer_Used, 64'h405860F5C0000000)) begin
                    if (LE(N, 64'h4061100000000000)) begin
                        if (LE(Rainfall, 64'h409B38CCD0000000)) begin
                    ...
                    if (LE(Soil_pH, 64'h401CE66660000000)) begin
                        if (LE(Soil_pH, 64'h40183851F0000000)) begin
                            yield_f_reg = 64'h405281EB851EB852;
                        end else begin
                            yield_f_reg = 64'h4052A70A3D70A3D7;
                        end
                    end else begin
                        if (LE(Fertilizer_Used, 64'h4065321480000000)) begin
                ...
                if (LE(P, 64'h4053000000000000)) begin
                    if (LE(N, 64'h405BC00000000000)) begin
                        if (LE(Altitude, 64'h40952C0000000000)) begin
            ...
            if (LE(Soil_pH, 64'h401F8A3D70000000)) begin
                if (LE(Fertilizer_Used, 64'h4060E68F60000000)) begin
                    if (LE(K, 64'h404B800000000000)) begin
                        yield_f_reg = 64'h405286147AE147AE;
                    end else begin
                        if (LE(Rainfall, 64'h40A3E04520000000)) begin
                    ...
                    if (LE(Soil_Moisture, 64'h403735C290000000)) begin
                        yield_f_reg = 64'h4052AF5C28F5C28F;
                    end else begin
                        if (LE(Fertilizer_Used, 64'h4066FD47B0000000)) begin
    ...
    if (LE(Rainfall, 64'h409932EB90000000)) begin
        if (LE(Soil_Moisture, 64'h40423851F0000000)) begin
            if (LE(Soil_pH, 64'h4015BD70A0000000)) begin
                yield_f_reg = 64'h4052747AE147AE14;
            end else begin
                if (LE(Humidity, 64'h4053E33330000000)) begin
                    if (LE(P, 64'h4055600000000000)) begin
                        if (LE(Fertilizer_Used, 64'h4071ED0A30000000)) begin
                            yield_f_reg = 64'h40528B851EB851EC;
                        end else begin
            ...
            if (LE(Rainfall, 64'h4084DFEB80000000)) begin
                ...
                if (LE(Soil_Moisture, 64'h404AAC28F0000000)) begin
                    if (LE(Soil_pH, 64'h4016EB8510000000)) begin
                        yield_f_reg = 64'h4052C51EB851EB85;
                    end else begin
                        if (LE(Sunlight_Hours, 64'h40207AE140000000)) begin
                    ...
                    if (LE(K, 64'h404A400000000000)) begin
                        ...
                        if (LE(Altitude, 64'h4091040000000000)) begin
        ...
        if (LE(Fertilizer_Used, 64'h4073DEB850000000)) begin
            if (LE(Soil_Moisture, 64'h4048FB8520000000)) begin
                if (LE(Wind_Speed, 64'h40225999A0000000)) begin
                    if (LE(N, 64'h4059C00000000000)) begin
                        if (LE(P, 64'h4048400000000000)) begin
                    ...
                    if (LE(Sunlight_Hours, 64'h4017E66660000000)) begin
                        ...
                        if (LE(Rainfall, 64'h409E573850000000)) begin
                ...
                if (LE(Humidity, 64'h4049BB8520000000)) begin
                    yield_f_reg = 64'h40534FAE147AE148;
                end else begin
                    if (LE(Altitude, 64'h408CD00000000000)) begin
            ...
            if (LE(Soil_Moisture, 64'h4042DF5C20000000)) begin
                if (LE(Rainfall, 64'h40A19C4F60000000)) begin
